...
var script = {
  ...
  methods: {
    ...
    filter: function filter(item) {
      ...
      if (item.dialCode.includes(queryText.replace('+', '')) || item.name.toLowerCase().includes(queryText.toLowerCase()) || item.iso2.toLowerCase().includes(queryText.toLowerCase())) {
        return true;
      }

      return false;
    },
    toggleIsFocused: function toggleIsFocused(isFocused) {
  ...
  return _c("div", {
    ...
    on: {
      ...
      focus: function focus($event) {
        return _vm.toggleIsFocused(true);
      },
      blur: function blur($event) {
        return _vm.toggleIsFocused(false);
      }
    },
    scopedSlots: _vm._u([{
      key: "selection",
      fn: function fn() {
        return [_c("div", {
          ...
          class: [_vm.activeCountry.iso2 ? _vm.activeCountry.iso2.toLowerCase() : "", {
            "d-none": _vm.isFocused
          }]
        })];
      },
      proxy: true
      ...
      fn: function fn(data) {
        return [_c("span", {
          staticClass: "vti__flag",
          class: data.item.iso2 ? data.item.iso2.toLowerCase() : ""
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  ...
  inject("data-v-95872dde_0", {
    ...
    map: {
      "version": 3,
      "sources": ["/Users/npavlova/Desktop/vue-tel-input-vuetify/src/lib/vue-tel-input-vuetify.vue", "vue-tel-input-vuetify.vue"],
      "names": [],
      "mappings": "AA+yBA;EACA,iBAAA;AC9yBA;ADizBA;EACA,aAAA;EACA,mBAAA;AC9yBA;ADgzBA;EACA,WAAA;AC9yBA;ADizBA;EACA,gCAAA;AC/yBA;ADmzBA;EACA,kBAAA;ACjzBA;ADkzBA;EACA,kBAAA;EACA,iBAAA;AChzBA;ADqzBA;EACA,iBAAA;ACnzBA;;AAEA,oDAAoD",
...
function install(Vue) {
  ...
  Vue.component('vue-tel-input-vuetify-combobox', __vue_component__);
}
var plugin = {
  install: install
}; // Auto-install
